...
const BeginnerOptions = (props) =>{
    ...
    return <div id="content-beginner-options">
        <div className="inline" style={{paddingBottom: "50px"}}><h1 style={{width:"70%"}}>What do you need?</h1>
            <a href="/homepage" style={{width:"10%",backgroundColor: "white",textAlign: "center",borderRadius:"10px",padding:"10px",marginRight: "20px"}}>
