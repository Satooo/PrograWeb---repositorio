...
const PreCheckout =()=>{
    ...
    const showPossibleCheckout = (click)=>{
        ...
        if(possibleCheckoutItems.length>0){
            ...
            return <h1 style={{textAlign:"center"}}>No more items</h1>;
        }
    }
    ...
    return <div id="content-margin" style={{width: "90%"}}>
        <div className="inline">
            ...
            <div className="col">
                ...
                <div style={{marginRight:"auto",marginLeft:"auto",width:"30%",backgroundColor:"rgba(0, 0, 0, 0.5)",textAlign:"center",borderTopRightRadius:"10px",borderTopLeftRadius:"10px",padding:"10px"}}><b>${getPrice()}</b></div>
